...
void count_events(string outfile = "hijing_reweighted_minbias_info.root") {
    ...
    for (int i = 0; i < 5000; i++) {
        TString mcWildcardPath = TString::Format("%sevents_hijing_reweighted_run14_waveformsim_nonoise_nozs_fixed_build_mc_cor_%d.root", mcInputDirectory, i);
