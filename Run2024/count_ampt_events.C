...
void count_ampt_events(string outfile = "ampt_reweighted_minbias_info.root") {
    ...
    for (int i = 0; i < 5000; i++) {
        TString mcWildcardPath = TString::Format("%sevents_ampt_reweighted_run14_waveformsim_nonoise_nozs_fixed_build_ampt_cor_%d.root", mcInputDirectory, i);
