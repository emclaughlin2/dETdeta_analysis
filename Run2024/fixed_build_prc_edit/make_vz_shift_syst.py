...
for cent in cents:
	...
	vardatafile = 'dETdeta_analysis_allruns_ana450_2024p009_100_50_50_ZS_hcal_scaled_emcal_calib_iter26,_nozs_data_noweight_'+cent+'_'+tag+'.root'
	outfile = 'dETdeta_variation_'+tag+'_'+cent+'.root'
