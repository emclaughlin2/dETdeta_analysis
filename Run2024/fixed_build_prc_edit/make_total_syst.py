...
for cent in cents:
	...
	testfile = "dETdeta_analysis_allruns_ana450_2024p009_100_50_50_ZS_hcal_scaled_emcal_calib_iter26_nozs_data_noweight_"+cent+".root"
	...
	outfile = ROOT.TFile.Open('dETdeta_total_variation_'+cent+'.root',"RECREATE")
