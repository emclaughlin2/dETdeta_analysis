...
tag = 'run_by_run'
outfile = '/sphenix/user/egm2153/calib_study/detdeta/analysis/Run2024/fixed_build_prc_edit/syst_covariance/dETdeta_signed_variation_run_by_run.root'
...
for c, cent in enumerate(cents):
    ...
    mcfile1 = '/sphenix/user/egm2153/calib_study/detdeta/analysis/Run2024/run_by_run_syst/dETdeta_analysis_allruns_run54911_acceptance_mb_ext_nozs_mc_reweight_'+cent+'_reweight_epos_2024.root'
    datafile1 = '/sphenix/user/egm2153/calib_study/detdeta/analysis/Run2024/run_by_run_syst/dETdeta_analysis_allruns_ana450_2024p009_54911_hcal_scaled_emcal_calib_iter26_ext_nozs_data_noweight_'+cent+'.root'
