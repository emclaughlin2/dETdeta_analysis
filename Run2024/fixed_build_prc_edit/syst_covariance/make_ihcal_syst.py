...
tags = ['1_ihsyst1','2_ihsyst2','3_ihsyst3']
for tag in tags:
	outfile = f'/sphenix/user/egm2153/calib_study/detdeta/analysis/Run2024/fixed_build_prc_edit/syst_covariance/dETdeta_signed_variation_{tag}.root'
	...
	for c, cent in enumerate(cents): 
		...
		vardatafile = '../dETdeta_analysis_allruns_ana450_2024p009_100_50_50_ZS_hcal_scaled_emcal_calib_iter26_ihcalsyst'+tag+'_nozs_data_noweight_'+cent+'.root'
		...
		neg_eta_emcal_detdeta_dev.SetBinContent(neg_eta_emcal_detdeta_dev.GetBin(1, c+1), neg_eta_emcal_detdeta_dev.GetBinContent(1, c+1) + emcal_detdeta_dev12.GetBinContent(1))
		pos_eta_emcal_detdeta_dev.SetBinContent(pos_eta_emcal_detdeta_dev.GetBin(1, c+1), pos_eta_emcal_detdeta_dev.GetBinContent(1, c+1) + emcal_detdeta_dev12.GetBinContent(6))
		neg_eta_emcal_detdeta_dev.SetBinContent(neg_eta_emcal_detdeta_dev.GetBin(2, c+1), neg_eta_emcal_detdeta_dev.GetBinContent(2, c+1) + emcal_detdeta_dev12.GetBinContent(2))
		pos_eta_emcal_detdeta_dev.SetBinContent(pos_eta_emcal_detdeta_dev.GetBin(2, c+1), pos_eta_emcal_detdeta_dev.GetBinContent(2, c+1) + emcal_detdeta_dev12.GetBinContent(5))
		neg_eta_emcal_detdeta_dev.SetBinContent(neg_eta_emcal_detdeta_dev.GetBin(3, c+1), neg_eta_emcal_detdeta_dev.GetBinContent(3, c+1) + emcal_detdeta_dev12.GetBinContent(3))
		pos_eta_emcal_detdeta_dev.SetBinContent(pos_eta_emcal_detdeta_dev.GetBin(3, c+1), pos_eta_emcal_detdeta_dev.GetBinContent(3, c+1) + emcal_detdeta_dev12.GetBinContent(4))
		...
		neg_eta_calo_detdeta_dev.SetBinContent(neg_eta_calo_detdeta_dev.GetBin(1, c+1), neg_eta_calo_detdeta_dev.GetBinContent(1, c+1) + calo_detdeta_dev12.GetBinContent(1))
		pos_eta_calo_detdeta_dev.SetBinContent(pos_eta_calo_detdeta_dev.GetBin(1, c+1), pos_eta_calo_detdeta_dev.GetBinContent(1, c+1) + calo_detdeta_dev12.GetBinContent(6))
		neg_eta_calo_detdeta_dev.SetBinContent(neg_eta_calo_detdeta_dev.GetBin(2, c+1), neg_eta_calo_detdeta_dev.GetBinContent(2, c+1) + calo_detdeta_dev12.GetBinContent(2))
		pos_eta_calo_detdeta_dev.SetBinContent(pos_eta_calo_detdeta_dev.GetBin(2, c+1), pos_eta_calo_detdeta_dev.GetBinContent(2, c+1) + calo_detdeta_dev12.GetBinContent(5))
		neg_eta_calo_detdeta_dev.SetBinContent(neg_eta_calo_detdeta_dev.GetBin(3, c+1), neg_eta_calo_detdeta_dev.GetBinContent(3, c+1) + calo_detdeta_dev12.GetBinContent(3))
		pos_eta_calo_detdeta_dev.SetBinContent(pos_eta_calo_detdeta_dev.GetBin(3, c+1), pos_eta_calo_detdeta_dev.GetBinContent(3, c+1) + calo_detdeta_dev12.GetBinContent(4))
		...
		neg_eta_hcal_detdeta_dev.SetBinContent(neg_eta_hcal_detdeta_dev.GetBin(1, c+1), neg_eta_hcal_detdeta_dev.GetBinContent(1, c+1) + hcal_detdeta_dev12.GetBinContent(1))
		pos_eta_hcal_detdeta_dev.SetBinContent(pos_eta_hcal_detdeta_dev.GetBin(1, c+1), pos_eta_hcal_detdeta_dev.GetBinContent(1, c+1) + hcal_detdeta_dev12.GetBinContent(6))
		neg_eta_hcal_detdeta_dev.SetBinContent(neg_eta_hcal_detdeta_dev.GetBin(2, c+1), neg_eta_hcal_detdeta_dev.GetBinContent(2, c+1) + hcal_detdeta_dev12.GetBinContent(2))
		pos_eta_hcal_detdeta_dev.SetBinContent(pos_eta_hcal_detdeta_dev.GetBin(2, c+1), pos_eta_hcal_detdeta_dev.GetBinContent(2, c+1) + hcal_detdeta_dev12.GetBinContent(5))
		neg_eta_hcal_detdeta_dev.SetBinContent(neg_eta_hcal_detdeta_dev.GetBin(3, c+1), neg_eta_hcal_detdeta_dev.GetBinContent(3, c+1) + hcal_detdeta_dev12.GetBinContent(3))
		pos_eta_hcal_detdeta_dev.SetBinContent(pos_eta_hcal_detdeta_dev.GetBin(3, c+1), pos_eta_hcal_detdeta_dev.GetBinContent(3, c+1) + hcal_detdeta_dev12.GetBinContent(4))
