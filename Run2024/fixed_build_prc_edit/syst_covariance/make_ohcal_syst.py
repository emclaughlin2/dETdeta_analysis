...
tags = ['1_ohsyst1','2_ohsyst2','3_ohsyst3']
for tag in tags:
	...
	for c, cent in enumerate(cents): 
		...
		vardatafile = '../dETdeta_analysis_allruns_ana450_2024p009_100_50_50_ZS_hcal_scaled_emcal_calib_iter26_ohcalsyst'+tag+'_nozs_data_noweight_'+cent+'.root'
