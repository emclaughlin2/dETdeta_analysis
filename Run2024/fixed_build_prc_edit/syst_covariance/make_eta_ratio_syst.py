...
# New pearson coefficients following prc edits 6/11/25
calo_rho_corr = [[0.8606, 0.8786, 0.8769, 0.8614, 0.8698, 0.7676, 0.9261, 0.9672], [0.9762, 0.9772, 0.9786, 0.9736, 0.9693, 0.7936, 0.9728, 0.9850], [0.9925, 0.9934, 0.9956, 0.9945, 0.9950, 0.8231, 0.9649, 0.9868]]
hcal_rho_corr = [[0.8543, 0.8499, 0.8393, 0.8303, 0.8122, 0.6331, 0.8759, 0.9821], [0.9662, 0.9692, 0.9661, 0.9601, 0.9493, 0.7221, 0.9496, 0.9936], [0.9947, 0.9938, 0.9937, 0.9931, 0.9894, 0.7471, 0.9392, 0.9946]]
emcal_rho_corr = [[0.9289, 0.9468, 0.9438, 0.9334, 0.9419, 0.9174, 0.9571, 0.9609], [0.9804, 0.9798, 0.9824, 0.9789, 0.9767, 0.9156, 0.9838, 0.9695], [0.9939, 0.9951, 0.9974, 0.9967, 0.9974, 0.9452, 0.9831, 0.9801]]

# person coefficients without ampt syst following prc edits 6/12/25
#emcal_rho_corr = [[0.9261, 0.9433, 0.9451, 0.9382, 0.9436, 0.9318, 0.9438, 0.9502], [0.9802, 0.9801, 0.9808, 0.9764, 0.9708, 0.9723, 0.9797, 0.9817], [0.9951, 0.9950, 0.9968, 0.9972, 0.9972, 0.9979, 0.9955, 0.9954]]
#hcal_rho_corr = [[0.8839, 0.8830, 0.8728, 0.8506, 0.8303, 0.7886, 0.7022, 0.7444], [0.9763, 0.9762, 0.9718, 0.9700, 0.9558, 0.9429, 0.9661, 0.9642], [0.9968, 0.9956, 0.9967, 0.9952, 0.9936, 0.9950, 0.9958, 0.9946]]
#calo_rho_corr = [[0.8729, 0.8837, 0.8879, 0.8714, 0.8752, 0.8551, 0.8611, 0.8746], [0.9790, 0.9795, 0.9782, 0.9746, 0.9662, 0.9641, 0.9771, 0.9810], [0.9944, 0.9941, 0.9963, 0.9954, 0.9951, 0.9969, 0.9947, 0.9953]]
...
for c, cent in enumerate(cents):
	y_max = {'0-5': 170, '5-10': 140, '10-20': 110, '20-30': 80, '30-40': 50, '40-50': 40, '50-60': 30, '60-70': 20}
	...
	for i in range(len(tag)-1):
		filename = '../dETdeta_variation_'+tag[i]+'_'+cent+'.root'
