...
tag = '60_30_30'
outfile = '/sphenix/user/egm2153/calib_study/detdeta/analysis/Run2024/fixed_build_prc_edit/syst_covariance/dETdeta_signed_variation_zs_'+tag+'ADC.root'
...
for c, cent in enumerate(cents):
	...
	vardatafile = '/sphenix/user/egm2153/calib_study/detdeta/analysis/Run2024/fixed_build_prc_edit/dETdeta_analysis_allruns_ana450_2024p009_100_50_50_ZS_hcal_scaled_emcal_calib_iter26,_nozs_data_noweight_'+cent+'_zs_'+tag+'.root'
