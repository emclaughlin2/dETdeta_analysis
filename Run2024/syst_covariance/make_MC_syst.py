...
emcal_detdeta_dev2 = TH1F("emcal_detdeta_dev2","",7,0,7)
hcal_detdeta_dev2 = TH1F("hcal_detdeta_dev2","",7,0,7)
calo_detdeta_dev2 = TH1F("calo_detdeta_dev2","",7,0,7)
emcal_detdeta_dev3 = TH1F("emcal_detdeta_dev3","",7,0,7)
hcal_detdeta_dev3 = TH1F("hcal_detdeta_dev3","",7,0,7)
calo_detdeta_dev3 = TH1F("calo_detdeta_dev3","",7,0,7)
for c, cent in enumerate(cents):
    ...
    mcfile1 = '/sphenix/user/egm2153/calib_study/detdeta/analysis/Run2024/fixed_build/dETdeta_analysis_allruns_run14_with_npart_nozs_mc_reweight_'+cent+'_reweight_ampt_2024.root'
    mcfile2 = '/sphenix/user/egm2153/calib_study/detdeta/analysis/Run2024/fixed_build/dETdeta_analysis_allruns_run14_with_npart_nozs_mc_reweight_'+cent+'_reweight_hijing_2024.root'
