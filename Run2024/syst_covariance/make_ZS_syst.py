...
tag = '60_30_30'
outfile = '/sphenix/user/egm2153/calib_study/detdeta/analysis/Run2024/syst_covariance/dETdeta_signed_variation_zs_'+tag+'ADC.root'
...
for c, cent in enumerate(cents):
	...
	vardatafile = '/sphenix/user/egm2153/calib_study/detdeta/analysis/Run2024/fixed_build/dETdeta_analysis_allruns_ana450_2024p009_100_50_50_ZS_hcal_tsc_emcal_calib_iter15,_nozs_data_noweight_'+cent+'_zs_'+tag+'.root'
