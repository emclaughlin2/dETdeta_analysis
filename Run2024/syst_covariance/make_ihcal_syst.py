...
for tag in tags:
	outfile = f'/sphenix/user/egm2153/calib_study/detdeta/analysis/Run2024/syst_covariance/dETdeta_signed_variation_{tag}.root'
	...
	for c, cent in enumerate(cents): 
		...
		vardatafile = '../fixed_build/dETdeta_analysis_allruns_ana450_2024p009_100_50_50_ZS_hcal_scaled_emcal_calib_iter26_ihcalsyst'+tag+'_nozs_data_noweight_'+cent+'.root'
