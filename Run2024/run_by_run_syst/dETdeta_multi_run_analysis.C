...
void fill_zvertex_centrality(int dataormc, const char* generator) {
	...
	if (dataormc) {
		...
		zvertexfile = new TFile(TString::Format("/sphenix/user/egm2153/calib_study/detdeta/analysis/Run2024/run_by_run_syst/dETdeta_vertex_reweight_run54914_%s_mb_ana450_2024p009_fixed_build.root", generator), "READ");
		...
		zvertexfile = new TFile("/sphenix/user/egm2153/calib_study/detdeta/analysis/Run2024/run_by_run_syst/dETdeta_vertex_reweight_run54914_reweight_epos_2024_mb_ana450_2024p009_fixed_build.root", "READ");
		TTree *vertextree = dynamic_cast<TTree*>(zvertexfile->Get("T"));
