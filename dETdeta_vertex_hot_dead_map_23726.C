...
void dETdeta_vertex_hot_dead_map_23726() {	
    ...
    //TString wildcardPath = TString::Format("%sevents_20231127_p004_data_cor_112.root", inputDirectory);
    TString wildcardPath = TString::Format("%sevents_20230104_p007A_23726_data_cor_*.root", inputDirectory);
	...
	TTreeReaderArray<bool> m_simtwr_cemc_isgood(reader, "emisgood");
	...
	TTreeReaderArray<bool> m_simtwr_ihcal_isgood(reader, "ihisgood");
	...
	TTreeReaderArray<bool> m_simtwr_ohcal_isgood(reader, "ohisgood");
