...
datafile = 'dETdeta_analysis_23727_z=0_p011_centbin_zs_30ADC_data_noweight_0-5.root'
...
vardatafile = 'dETdeta_analysis_23727_z=0_emcal_syst3d_zs_30ADC_data_noweight_0-5.root'
outfile = 'dETdeta_variation_EMCAL_SYST3_LOW_BOUND.root'
...
emcal_hijing_dev.SetYTitle("dE_{T}/d#eta dev. [GeV]")
for i in range(1, emcal_hijing_dev.GetNbinsX() + 1):
	emcal_hijing_dev.SetBinContent(i, emcal_detdeta_hijing.GetBinContent(i) - emcal_var_detdeta_hijing.GetBinContent(i))
...
emcal_epos_dev.SetYTitle("dE_{T}/d#eta dev. [GeV]")
for i in range(1, emcal_epos_dev.GetNbinsX() + 1):
	emcal_epos_dev.SetBinContent(i, emcal_detdeta_epos.GetBinContent(i) - emcal_var_detdeta_epos.GetBinContent(i))
