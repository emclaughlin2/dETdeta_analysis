...
cent = sys.argv[1]
tag = sys.argv[2]
mcfile = 'MC/dETdeta_analysis_allruns_p015_nozs_mc_reweight_'+cent+'_reweight_hijing.root'
datafile = 'emcal_syst/dETdeta_analysis_allruns_p015_HCal_zs_30ADC_EMCal_zs_40ADC_data_noweight_'+cent+'.root'
vardatafile = 'emcal_syst/dETdeta_analysis_allruns_p015_'+tag+'_HCal_zs_30ADC_EMCal_zs_40ADC_data_noweight_'+cent+'.root'
outfile = 'emcal_syst/dETdeta_variation_'+tag+'_'+cent+'.root'
