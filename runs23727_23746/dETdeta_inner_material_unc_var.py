...
for cent in cents:
	...
	datafile = 'zs_syst/dETdeta_analysis_allruns_p015_HCal_zs_30ADC_EMCal_zs_40ADC_data_noweight_'+cent+'.root'
	vardatafile = 'zs_syst/dETdeta_analysis_allruns_p015_HCal_zs_'+str(tag)+'ADC_EMCal_zs_'+str(tag+10)+'ADC_data_noweight_'+cent+'.root'
	outfile = 'zs_syst/dETdeta_variation_zs_'+str(tag)+'ADC_'+cent+'.root'
	...
	h_eT_var_truth = TH1F(f5.Get("hetdeta_ihcalbin"))
	h_eT_var_truth_ihcalbin = TH1F(f5.Get("hetdeta_ihcalbin"))
	h_eT_var_truth_ohcalbin = TH1F(f5.Get("hetdeta_ohcalbin"))
	h_eT_var_truth_calobin = TH1F(f5.Get("hetdeta_calobin"))
	...
	h_eT_var_truth.SetDirectory(0)
	h_eT_var_truth_ihcalbin.SetDirectory(0)
	h_eT_var_truth_ohcalbin.SetDirectory(0)
	h_eT_var_truth_calobin.SetDirectory(0)
