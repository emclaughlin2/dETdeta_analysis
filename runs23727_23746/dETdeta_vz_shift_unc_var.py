...
for cent in cents:
	...
	vardatafile = 'global_syst/dETdeta_analysis_allruns_'+tag+'_HCal_zs_30ADC_EMCal_zs_40ADC_data_noweight_'+cent+'.root'
	outfile = 'global_syst/dETdeta_variation_'+str(tag)+'_w_hcal_'+cent+'.root'
	...
	emcal_var_detdeta_mc = TH1F(h_eT_data_emcal.Clone("emcal_var_detdeta_mc"))
	ihcal_var_detdeta_mc = TH1F(h_eT_data_ihcal.Clone("ihcal_var_detdeta_mc"))
	ohcal_var_detdeta_mc = TH1F(h_eT_data_ohcal.Clone("ohcal_var_detdeta_mc"))
	calo_var_detdeta_mc = TH1F(h_eT_data_calo.Clone("calo_var_detdeta_mc"))
	hcal_var_detdeta_mc = TH1F(h_eT_data_hcal.Clone("hcal_var_detdeta_mc"))
	for i in range(1, h_eT_var_emcal.GetNbinsX() + 1):
		emcal_var_detdeta_mc.SetBinContent(i,h_eT_var_emcal.GetBinContent(i))
		emcal_var_detdeta_mc.SetBinError(i,h_eT_var_emcal.GetBinError(i))
	for i in range(1, h_eT_var_ihcal.GetNbinsX() + 1):
		ihcal_var_detdeta_mc.SetBinContent(i,h_eT_var_ihcal.GetBinContent(i))
		ihcal_var_detdeta_mc.SetBinError(i,h_eT_var_ihcal.GetBinError(i))
	for i in range(1, h_eT_var_ohcal.GetNbinsX() + 1):
		ohcal_var_detdeta_mc.SetBinContent(i,h_eT_var_ohcal.GetBinContent(i))
		ohcal_var_detdeta_mc.SetBinError(i,h_eT_var_ohcal.GetBinError(i))
	for i in range(1, h_eT_var_calo.GetNbinsX() + 1):
		calo_var_detdeta_mc.SetBinContent(i,h_eT_var_calo.GetBinContent(i))
		calo_var_detdeta_mc.SetBinError(i,h_eT_var_calo.GetBinError(i))
	for i in range(1, h_eT_var_hcal.GetNbinsX() + 1):
		hcal_var_detdeta_mc.SetBinContent(i,h_eT_var_hcal.GetBinContent(i))
		hcal_var_detdeta_mc.SetBinError(i,h_eT_var_hcal.GetBinError(i))
