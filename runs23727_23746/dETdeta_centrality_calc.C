...
void dETdeta_centrality_calc(int runnumber, const char* generator) {	

	TFile *out = new TFile(TString::Format("dETdeta_centrality_run%d_%s_p011.root",runnumber, generator),"RECREATE");
