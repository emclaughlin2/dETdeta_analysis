...
root.exe -q -b 'dETdeta_analysis.C('$1',"reweight_hijing",-20,20,1,1,1,30,40,0,0,0,"4_4_24")' >> "run_by_run_studies/hijing_ext_run$1_log.txt"
root.exe -q -b 'dETdeta_analysis.C('$1',"reweight_hijing",-20,20,1,1,1,40,50,0,0,0,"4_4_24")' >> "run_by_run_studies/hijing_ext_run$1_log.txt"
root.exe -q -b 'dETdeta_analysis.C('$1',"reweight_hijing",-20,20,1,1,1,50,60,0,0,0,"4_4_24")' >> "run_by_run_studies/hijing_ext_run$1_log.txt"